/*Ejercicio 2- Dado el sueldo de un empleado imprimir en un alerta el nuevo suledo de un empleado si tuvo un aumento del 10% 
...
/*Ejercicio 3- Un vendedor que tiene su sueldo base , recibe una comisión del 30% del total de las ventas del mes, el quiere saber
cuanto ganara en un mes que tuvo tres ventas */

/*let sueldo = prompt("Ingrese el valor del sueldo");
let ventas= prompt("ingrese el valor de las ventas");
let pventas= (100/30);
let total = parseInt(sueldo) + parseInt(ventas*pventas);
...
let exafinal= parseInt(califinal*promedio2);
...
let califin= parseInt(trabFinal*promedio3);
 ...
 let totalPagoKm=parseInt(kmRecorrido*costoPorkm);
 let mnRecorridos= prompt("Agregue la cantidad de minutos recorridos");
 const costoPorMn=2000;
 let totalPagoMn=parseInt(mnRecorridos*costoPorMn);

 let totalPago=parseInt(totalPagoKm+totalPagoMn);
